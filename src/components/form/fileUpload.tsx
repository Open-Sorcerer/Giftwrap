...
function FileUpload({ selectedFile, setSelectedFile }: FileUploadProps): React.ReactElement {
  ...
  return (
    <button
      className="text-textColor flex min-h-[7rem] w-full cursor-pointer flex-col items-center gap-y-2 rounded-[.625rem] border border-neutral-600 bg-neutral-800 px-6 py-2 tracking-wide shadow-lg"
